                     ...
                     <div className="flex flex-col gap-2 w-full sm:w-auto">
                       {fileUrls.map((url: string, idx: number) => (
                         <a
                           ...
                           target="_blank"
                           rel="noreferrer"
                           className="flex items-center gap-2 px-6 py-3 bg-amber-500 text-white text-[15px] font-bold rounded-xl hover:bg-amber-600 transition-colors shadow-sm w-full justify-center"
                         >
