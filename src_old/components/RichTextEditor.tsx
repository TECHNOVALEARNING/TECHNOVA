...
export function RichTextEditor({ value, onChange, label, withAI = false, productTitle, productType }: RichTextEditorProps) {
...
"${value || 'Rédige une description complète, vendeuse et attrayante pour ce produit en partant de zéro.'}"
