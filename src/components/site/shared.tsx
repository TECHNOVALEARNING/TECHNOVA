    ...
    <header className="fixed w-full top-0 z-50 backdrop-blur-md bg-background/80 border-b border-border shadow-sm">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-4">
          ...
          >
            <i className="fa-solid fa-globe text-sm" /> {lang.toUpperCase()}
          </button>
          <button
          ...
          <ul className="space-y-2.5 text-white/70 text-sm">
            {[
              ...
              <li key={lnk.label} className="flex items-center gap-2">
                <i className="fa-solid fa-chevron-right text-[10px] flex-none text-[color:var(--primary)]" />
        ...
        <div>
          ...
          <ul className="space-y-3 text-white/70 text-sm">
            <li className="flex gap-2.5 items-start">
              <i className="fa-solid fa-envelope text-sm mt-1 flex-none text-[color:var(--primary)]" />
              <a
