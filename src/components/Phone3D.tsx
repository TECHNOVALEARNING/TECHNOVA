  ...
  return (
    <div className="relative" style={{ perspective: "1200px" }}>
          ...
          <div className="absolute inset-[3px] rounded-[2.3rem] bg-gradient-to-b from-zinc-950 to-zinc-900 overflow-hidden">
            ...
            <div className="absolute inset-[2px] top-0 rounded-[2.2rem] bg-gradient-to-b from-background to-secondary/50 overflow-hidden p-3 pt-8">
              ...
              <div className="text-center mb-3">
                <p
                  className={`${compact ? "text-[9px]" : "text-[11px]"} font-semibold text-foreground/60 uppercase tracking-wider`}
                >
                  TECHNOVA
                </p>
                <p className={`${compact ? "text-sm" : "text-lg"} font-bold text-foreground mt-1`}>
                  Mon Portefeuille
                </p>
              </div>
              ...
              <div className="rounded-2xl bg-gradient-to-br from-primary to-primary/80 p-3 mb-3 shadow-lg shadow-primary/20">
                ...
                <p
                  className={`${compact ? "text-base" : "text-xl"} font-extrabold text-primary-foreground`}
                >
                  1 250 000 F
                </p>
              ...
              <div className="space-y-1.5">
                <p className="text-[9px] font-semibold text-foreground/50 uppercase tracking-wider px-1">
                  Récent
                </p>
      ...
      <motion.div
        ...
        className={
          compact ? "absolute -top-2 -right-4 z-20" : "absolute -top-4 -right-8 md:-right-16 z-20"
        }
      >
        <motion.div
          animate={{ y: [0, -6, 0] }}
        ...
        >
          <div
            className={`${compact ? "h-8 w-8" : "h-10 w-10"} rounded-full bg-primary/15 flex items-center justify-center shrink-0`}
          >
            <CheckCircle className={`${compact ? "h-4 w-4" : "h-5 w-5"} text-primary`} />
          </div>
          <div>
            <p className={`${compact ? "text-[10px]" : "text-xs"} font-bold text-card-foreground`}>
              Retrait effectué ✅
            </p>
            <p className={`${compact ? "text-[8px]" : "text-[10px]"} text-muted-foreground mt-0.5`}>
              Votre retrait a été bien effectué
            </p>
            <p
              className={`${compact ? "text-[8px]" : "text-[10px]"} font-semibold text-primary mt-0.5`}
            >
              500 000 FCFA
            </p>
          </div>
