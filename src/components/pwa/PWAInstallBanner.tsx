...
import { Download, Smartphone, X, Sparkles, Share, PlusSquare, ArrowRight } from "lucide-react";
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <DialogDescription className="text-xs text-muted-foreground">
                  Suivez ces 2 étapes simples sur Safari pour ajouter l'app à votre écran d'accueil :
                </DialogDescription>
              </div>
            </div>
          </DialogHeader>
          ...
          <div className="space-y-3.5 my-2">
            <div className="flex items-center gap-3.5 p-3.5 rounded-2xl bg-secondary/40 border border-border">
              ...
              <div className="text-xs">
                ...
                <span className="text-muted-foreground">Situé dans la barre en bas de votre navigateur Safari.</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3.5 p-3.5 rounded-2xl bg-secondary/40 border border-border">
              ...
              <div className="text-xs">
                ...
                <span className="text-muted-foreground">Faites défiler puis appuyez sur « Ajouter ».</span>
              </div>
            </div>
          </div>
