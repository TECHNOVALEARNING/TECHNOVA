      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full md:w-auto">
          <Button
            asChild
            variant="default"
            className="h-12 px-5 rounded-full gap-2 font-bold shadow-sm bg-gradient-to-r from-blue-600 to-indigo-600 text-white hover:from-blue-700 hover:to-indigo-700 transition-all shrink-0"
          >
            <a href="https://topapps.fr" target="_blank" rel="noopener noreferrer">
              <span>{lang === "fr" ? "Plus d'outils" : "More tools"}</span>
