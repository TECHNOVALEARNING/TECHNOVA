              ...
              >
                <div>
                  <div className="course-img-wrap h-64 relative overflow-hidden">
                    ...
                    />
                    <span className="course-badge">{app.category}</span>
                  </div>

                  <div className="course-body p-6">
                    <h3
                      className="font-bold text-xl mb-3 text-[color:var(--text)] font-display"
                ...
                <div className="p-6 pt-0 border-t border-[color:var(--divider)]">
                  <div className="flex flex-wrap gap-1.5 mb-5 pt-4">
                    {app.tags.map((tag) => (
                      <span
                        key={tag}
                        className="px-2.5 py-0.5 rounded-lg bg-muted text-[10px] text-muted-foreground font-mono font-medium"
                      >
                        {tag}
                      </span>
                    ))}
