...
export default function ToolsDirectoryPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300 font-sans">
      <SEOHead 
        title={lang === "fr" ? "Fonctionne avec TECHNOVA | L'Annuaire des Outils Digitaux" : "Works with TECHNOVA | Digital Tools Directory"}
        description={lang === "fr" ? "Découvrez notre annuaire des meilleurs outils digitaux, logiciels IA, e-commerce et création pour développer votre activité." : "Discover our directory of the best digital tools, AI software, e-commerce, and design tools to grow your business."}
      />
      <Header />
