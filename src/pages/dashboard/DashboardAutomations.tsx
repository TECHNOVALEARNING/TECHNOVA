      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Automatisez vos emails et notifications
          </p>
        </div>
                  ...
                  <div className="space-y-4 pt-2">
                    ...
                    <div>
                      ...
                      <Select value={triggerEvent} onValueChange={setTriggerEvent}>
                        <SelectTrigger>
                          <SelectValue placeholder="Quand déclencher ?" />
                        </SelectTrigger>
                        <SelectContent>
                    ...
                    <div>
                      ...
                      <Select value={actionType} onValueChange={setActionType}>
                        <SelectTrigger>
                          <SelectValue placeholder="Que faire ?" />
                        </SelectTrigger>
                        <SelectContent>
                          {actionOptions.map((o) => (
                            <SelectItem key={o.value} value={o.value}>
                    ...
                    <Button
                      ...
                      disabled={saving || !name.trim() || !triggerEvent || !actionType}
                      className="w-full"
                    >
                ...
                {automations.map((a) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div
                        className={`h-8 w-8 rounded-lg flex items-center justify-center ${a.is_active ? "bg-primary/10" : "bg-muted"}`}
                      >
                        <Zap
                          className={`h-4 w-4 ${a.is_active ? "text-primary" : "text-muted-foreground"}`}
                        />
                      </div>
                      <div>
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex items-start gap-3">
                        <div
                          className={`h-2 w-2 rounded-full mt-1.5 ${n.is_read ? "bg-transparent" : "bg-primary"}`}
                        />
                        <div>
