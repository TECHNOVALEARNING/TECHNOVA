                  ...
                  >
                    <div className="flex items-center gap-3 sm:gap-4 min-w-0">
                      ...
                      <div className="min-w-0 pr-2">
                        ...
                        <p className="text-[12px] sm:text-[13px] text-muted-foreground font-medium mt-0.5 truncate">{Number(p.price || 0).toLocaleString()}{currencySuffix}</p>
                      </div>
                    </div>
                    <div className="text-right shrink-0">
                      <p className="text-[14px] sm:text-[15px] font-bold text-foreground">{p.salesTotal.toLocaleString()}{currencySuffix}</p>
