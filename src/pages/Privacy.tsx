...
const Privacy = () => {
  ...
  const sections = [
    ...
    {
      title:
        lang === "fr" ? "10. Vérification d'identité (KYC)" : "10. Identity Verification (KYC)",
      content:
        lang === "fr"
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        title={
          lang === "fr" ? "Politique de confidentialité · TECHNOVA" : "Privacy Policy · TECHNOVA"
        }
        description={
          lang === "fr"
            ? "Politique de confidentialité d'TECHNOVA. Découvrez comment nous collectons, utilisons et protégeons vos données personnelles."
            : "Privacy Policy of TECHNOVA. Discover how we collect, use and protect your personal data."
        }
