        ...
        <div className="container mx-auto px-6 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10">
              Formations complètes avec vidéos, quiz, certificats et suivi de progression — tout en
              un seul endroit.
            </p>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-sm text-muted-foreground">
              {lang === "fr"
                ? "Explorez nos programmes intensifs officiels pour acquérir les compétences les plus recherchées du marché."
                : "Explore our official intensive programs to gain the most sought-after skills on the market."}
            </p>
          </div>
          ...
          {isLoading ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {[...Array(4)].map((_, i) => (
                <div
                  key={i}
                  className="rounded-3xl border border-border bg-card p-4 h-[380px] animate-pulse flex flex-col justify-between"
                >
            ...
            <div className="text-center py-16 rounded-3xl border border-dashed border-border bg-card max-w-md mx-auto">
              ...
              <p className="text-sm text-muted-foreground">
                {lang === "fr"
                  ? "Revenez plus tard pour découvrir nos prochains cours officiels."
                  : "Check back later to explore our upcoming official courses."}
              </p>
            </div>
          )}
        </div>
