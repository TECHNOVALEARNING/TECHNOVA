...
const Terms = () => {
  ...
  const sections = [
    ...
    {
      title: lang === "fr" ? "3. Inscription et vérification d'identité (KYC)" : "3. Registration and Identity Verification (KYC)",
      content: lang === "fr"
    ...
    {
      title: lang === "fr" ? "4. Produits autorisés et modération" : "4. Authorized Products and Moderation",
      content: lang === "fr"
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead 
        title={lang === "fr" ? "Conditions d'utilisation · TECHNOVA" : "Terms of Service · TECHNOVA"} 
        description={lang === "fr" ? "Conditions générales d'utilisation de la plateforme TECHNOVA. Politique de confidentialité et mentions légales." : "General terms of service of the TECHNOVA platform. Privacy policy and legal notices."} 
        canonicalPath="/terms" 
        noindex 
      />
      <Header />
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <h1 className="text-4xl md:text-6xl font-extrabold text-foreground mb-6" style={{ fontFamily: "'Outfit', sans-serif" }}>
              {lang === "fr" ? (
                <>Conditions <span className="bg-gradient-to-r from-blue-500 to-indigo-500 bg-clip-text text-transparent">d'utilisation</span></>
              ) : (
                <>Terms of <span className="bg-gradient-to-r from-blue-500 to-indigo-500 bg-clip-text text-transparent">Service</span></>
              )}
            </h1>
