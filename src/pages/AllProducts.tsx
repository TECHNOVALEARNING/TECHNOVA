  ...
  return (
    <div className="min-h-screen overflow-x-hidden transition-colors duration-300" style={{ background: "var(--bg, #f2f2f7)", color: "var(--text, #1d1d1f)", fontFamily: "'Manrope', -apple-system, sans-serif" }}>
      <SEOHead
        ...
        title={lang === "fr" ? "Catalogue de tous les produits TECHNOVA" : "TECHNOVA All Products Catalog"}
        description={lang === "fr" ? "Découvrez toutes les formations, ebooks et ressources technologiques publiés par l'ensemble des vendeurs certifiés sur TECHNOVA." : "Explore all the courses, ebooks, and tech resources published by all certified sellers on TECHNOVA."}
      />
      <Header />
        ...
        <div className="container mx-auto px-4 max-w-4xl relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-1.5 rounded-full border border-blue-500/25 bg-[color:var(--blue-soft)] px-3.5 py-1 text-xs font-semibold text-[color:var(--blue)] backdrop-blur mb-6">
              <Sparkles className="h-3.5 w-3.5" /> {lang === "fr" ? "Catalogue Complet Marketplace" : "Complete Marketplace Catalog"}
            </div>
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-[color:var(--text)] font-display leading-[1.15] mb-6" style={{ fontFamily: "'Outfit', sans-serif" }}>
              {lang === "fr" ? <>Tous nos Produits <span className="bg-gradient-to-r from-blue-500 to-indigo-500 bg-clip-text text-transparent">Digitaux</span></> : <>All Digital <span className="bg-gradient-to-r from-blue-500 to-indigo-500 bg-clip-text text-transparent">Products</span></>}
            </h1>
            <p className="text-base sm:text-lg text-[color:var(--text-secondary)] leading-relaxed max-w-xl mx-auto mb-10">
              {lang === "fr" ? "Explorez et achetez les produits de tous nos créateurs et formateurs indépendants." : "Explore and buy products from all our independent creators and trainers."}
            </p>
