  ...
  return (
    ...
    >
      <SEOHead
        ...
        title={
          lang === "fr"
            ? "Catalogue de tous les produits TECHNOVA"
            : "TECHNOVA All Products Catalog"
        }
        description={
          lang === "fr"
            ? "Découvrez toutes les formations, ebooks et ressources technologiques publiés par l'ensemble des vendeurs certifiés sur TECHNOVA."
            : "Explore all the courses, ebooks, and tech resources published by all certified sellers on TECHNOVA."
        }
      />
      <Header />
        ...
        <div className="container mx-auto px-4 max-w-4xl relative z-10">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-[color:var(--text-secondary)] leading-relaxed max-w-xl mx-auto mb-10">
              {lang === "fr"
                ? "Explorez et achetez les produits de tous nos créateurs et formateurs indépendants."
                : "Explore and buy products from all our independent creators and trainers."}
            </p>
