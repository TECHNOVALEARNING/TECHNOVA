...
const LegalNotice = () => {
  return (
    <div className="min-h-screen bg-background">
      <SEOHead title="Mentions légales" description="Mentions légales d'TECHNOVA, plateforme de vente de produits digitaux opérée par Dolapo ECOM LLC." canonicalPath="/legal" noindex />
      <Header />
            ...
            {[
              {
                ...
                content: "Le site TECHNOVA (accessible à l'adresse technova.com) est édité par Dolapo ECOM LLC, société à responsabilité limitée enregistrée dans l'État du Nouveau-Mexique, États-Unis. Siège social : 1209 Mountain Rd PL NE, Ste R, Albuquerque, NM 87110, USA. Email : contact@technova.com."
              },
              {
                title: "2. Directeur de la publication",
                content: "Le directeur de la publication est le gérant de Dolapo ECOM LLC. Contact : contact@technova.com."
              },
              {
                title: "3. Hébergement",
              ...
              },
              {
                ...
                content: "Les transactions sont chiffrées et traitées par Moneroo (certifié PCI-DSS). TECHNOVA ne stocke aucune donnée bancaire. Les fonds issus des ventes sont placés en délai de maturation pendant 72 heures afin de prévenir toute fraude au remboursement. La plateforme applique le chiffrement TLS et l'isolation Row-Level Security pour protéger l'intégralité des données utilisateurs."
              },
              {
                title: "5. Propriété intellectuelle",
                content: "L'ensemble du contenu du site TECHNOVA (textes, images, graphismes, logo, icônes, logiciels) est la propriété exclusive de Dolapo ECOM LLC ou de ses partenaires et est protégé par les lois relatives à la propriété intellectuelle. Toute reproduction, représentation, modification ou exploitation non autorisée est interdite."
              },
              {
                title: "6. Données personnelles",
                content: "Les données personnelles collectées sur ce site sont traitées conformément à notre Politique de confidentialité, accessible à l'adresse /privacy. Pour toute question relative à vos données personnelles, contactez-nous à contact@technova.com."
              },
              {
                title: "7. Cookies",
              ...
              {
                title: "10. Contact",
                content: "Pour toute question ou réclamation, vous pouvez nous contacter par email à contact@technova.com ou par courrier à Dolapo ECOM LLC, 1209 Mountain Rd PL NE, Ste R, Albuquerque, NM 87110, USA."
              },
            ].map((section) => (
