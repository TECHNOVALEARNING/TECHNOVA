...
export const topTools: Tool[] = [
  ...
  // --- NOUVEAUX OUTILS AJOUTÉS (IA, Marketing, Fintech, Design) ---
  {
    id: "writesonic",
    name: "Writesonic",
    description: "Générateur de texte et d'images IA conçu spécifiquement pour créer du contenu optimisé SEO pour les blogs et publicités.",
  ...
  },
  {
    id: "krea-ai",
    name: "Krea AI",
    description: "Génération et amélioration d'images en temps réel avec l'IA. Un outil révolutionnaire pour les designers et créatifs.",
  ...
  },
  {
    ...
    description: "Générateur de vidéos IA ultra-réalistes et rapides à partir de texte ou d'images.",
  ...
  },
  {
    id: "mistral-ai",
    name: "Mistral AI",
    description: "Le fleuron français de l'Intelligence Artificielle. Modèles open-source extrêmement performants et rapides (Le Chat).",
  ...
  },
  {
    ...
    description: "L'outil de référence mondial et gratuit pour suivre et analyser le trafic et le comportement de vos utilisateurs.",
  ...
  },
  {
    ...
    description: "La plateforme publicitaire incontournable pour créer et gérer des campagnes ciblées sur Facebook et Instagram.",
  ...
  },
  {
    id: "hootsuite",
    name: "Hootsuite",
    description: "Gérez tous vos réseaux sociaux (planification, publication, analyse) depuis un seul et même tableau de bord.",
  ...
  },
  {
    id: "ubersuggest",
    name: "Ubersuggest",
    description: "Outil SEO abordable de Neil Patel pour trouver des mots-clés, des idées de contenu et analyser la concurrence.",
  ...
  },
  {
    id: "activecampaign",
    name: "ActiveCampaign",
    description: "Plateforme puissante d'automatisation de l'expérience client (CXA) combinant email marketing, automatisation et CRM.",
  ...
  },
  {
    id: "adobe-firefly",
    name: "Adobe Firefly",
    description: "La famille de modèles d'IA générative créative d'Adobe, conçue pour un usage commercial en toute sécurité.",
  ...
  },
  {
    id: "capcut",
    name: "CapCut",
    description: "Éditeur vidéo tout-en-un gratuit de ByteDance (TikTok) très puissant pour PC, Mac et mobile.",
  ...
  },
  {
    ...
    description: "Le seul logiciel de montage vidéo, étalonnage, effets visuels et post-production audio de qualité hollywoodienne gratuit.",
  ...
  },
  {
    id: "blender",
    name: "Blender",
    description: "La suite de création 3D open-source et gratuite. Modélisation, animation, rendu, compositing et montage vidéo.",
  ...
  },
  {
    id: "asana",
    name: "Asana",
    description: "Plateforme de gestion de travail pour organiser, suivre et gérer les projets et tâches de votre équipe.",
  ...
  },
  {
    id: "monday",
    name: "Monday.com",
    description: "Système d'exploitation de travail visuel (Work OS) permettant aux équipes de créer des flux de travail personnalisés.",
  ...
  },
  {
    id: "clickup",
    name: "ClickUp",
    description: "Une seule application pour les remplacer toutes. Tâches, documents, discussions, objectifs et bien plus.",
  ...
  },
  {
    ...
    description: "Tous vos outils professionnels familiers (Gmail, Drive, Docs, Meet) centralisés pour les entreprises.",
  ...
  },
  {
    id: "paypal",
    name: "PayPal",
    description: "La solution mondiale de paiement en ligne, rapide et sécurisée pour envoyer et recevoir de l'argent.",
  ...
  },
  {
    id: "skrill",
    name: "Skrill",
    description: "Portefeuille numérique mondial permettant de payer en ligne, envoyer de l'argent et acheter des cryptos.",
  ...
  },
  {
    id: "prestashop",
    name: "PrestaShop",
    description: "Logiciel e-commerce open-source d'origine française, très puissant et utilisé par des milliers de boutiques.",
  ...
  },
  {
    id: "bigcommerce",
    name: "BigCommerce",
    description: "Plateforme e-commerce cloud très robuste, idéale pour les entreprises en forte croissance (SaaS).",
  ...
  },
  {
    id: "hostinger",
    name: "Hostinger",
    description: "Hébergement web rapide, sécurisé et très abordable. Parfait pour lancer son premier site WordPress.",
  ...
  },
  {
    id: "canva-video",
    name: "Canva Vidéo",
    description: "L'éditeur vidéo intégré à Canva, simple et intuitif pour créer des TikToks, Reels et vidéos YouTube.",
